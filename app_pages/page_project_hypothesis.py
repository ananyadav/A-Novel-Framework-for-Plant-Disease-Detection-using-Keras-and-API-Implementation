...
def page_project_hypothesis_body():
    ...
    st.success(
        ...
        f"**How it Works **\n"
        f"* Simply upload an image of a apple leaf, and our trained model will predict whether the plant is Healthy, has Powdery Mildew, or is affected by Rust.\n"
        f"* The trained model provides some suggestions for treating plant diseases.\n\n"
        f"** Dataset **\n"
        f"* We trained our model using a dataset of labeled images containing Healthy, Powdery, and Rust-afflicted apple leaves. This ensures accurate predictions for your images.\n\n"
    ...
    st.info(
        f"** Success Criteria **\n"
        f"- **Accurate Predictions:** Our model achieves high accuracy in identifying plant diseases for apple leafs.\n"
        f"- **User-Friendly Interface:** The app is designed to be intuitive for farmers to use.\n"
        f"- **Early Disease Detection:** We aim to contribute to early detection of apple plant diseases.\n"
    )
